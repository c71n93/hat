...
public class GameSettingsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable final Bundle savedInstanceState) {
        ...
        next.setOnClickListener(button -> PlayersNumber.tryFromText(playersInput).ifPresentOrElse(value -> {
            GameViewModel.self(requireActivity()).updatePlayers(value);
            Navigation.findNavController(button).navigate(R.id.action_gameSettingsFragment_to_gameSummaryFragment);
